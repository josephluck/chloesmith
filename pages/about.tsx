...
export default function About() {
  return (
    ...
    >
      <p className="ma0 pb3">
        I&apos;m a womenswear fashion designer based in London. I enjoy working
        for fast pace, fashion forward high-street brands.
      </p>
      <p className="ma0 pb3">
        Get in touch at
        <a
      ...
      <List
        ...
        items={[
          ...
          },
          {
            name: "Debenhams",
            description:
              "Womenswear Design Intern and Accessories Design Intern",
          },
          {
            name: "Jasper Conran",
